...
public class Client
{
    private const int ApiId = 20346937; // Получить на https://my.telegram.org/apps
    private const string ApiHash = "f6aad01d4a9256f9ff4fe09863b948c9"; // Получить на https://my.telegram.org/apps
    private const string PhoneNumber = "+79506955224"; // Свой номер
